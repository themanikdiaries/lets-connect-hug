    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight fade-in-up" style={{ animationDelay: "0.1s" }}>
            Bridges between{" "}
            <span className="gradient-text">juniors and seniors</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 fade-in-up" style={{ animationDelay: "0.3s" }}>
            <Button 
              size="lg" 
              onClick={onJoinClick} 
